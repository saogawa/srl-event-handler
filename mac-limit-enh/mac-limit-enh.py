    ...
    example_in_json_str = """
{
   "paths":[
      ...
      {
         "path":"interface ethernet-1/2 subinterface 20 bridge-table mac-limit maximum-entries",
         "value":"250"
      },
      {
         "path":"interface ethernet-1/2 subinterface 20 bridge-table statistics active-entries",
         "value":"1"
      },
      {
         "path":"interface ethernet-1/2 subinterface 21 bridge-table mac-limit maximum-entries",
         "value":"250"
      },
      {
         "path":"interface ethernet-1/2 subinterface 21 bridge-table statistics active-entries",
         "value":"1"
      },
      {
         "path":"interface ethernet-1/5 subinterface 30 bridge-table mac-limit maximum-entries",
         "value":"250"
      },
      {
         "path":"interface ethernet-1/5 subinterface 30 bridge-table statistics active-entries",
         "value":"0"
      },
      {
         "path":"interface lag1 subinterface 30 bridge-table mac-limit maximum-entries",
         "value":"5"
      },
      {
         "path":"interface lag1 subinterface 30 bridge-table statistics active-entries",
         "value":"5"
      }
   ],
   "schemas":[
      {
         "path":"interface * subinterface * bridge-table mac-limit maximum-entries"
      },
      {
         "path":"interface * subinterface * bridge-table statistics active-entries"
      }
   ],
   "options":{
